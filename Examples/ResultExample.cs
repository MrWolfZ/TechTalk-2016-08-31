using System;
using Examples.Templates._03Result;
using Functional;
  ...
  public static class ResultExample
  {
    public static Unit Run()
    {
      ...
      while (true)
      {
        ...
        bank = opt.Bind(res => res.DoIfFailure(err => Console.Error.WriteLine($"An error occured during the operation: {err}")).ToOption())
                  .GetOrElse(bank);
      }
    ...
    private static Func<int, Option<Result<Bank, string>>> ChooseOperation(Bank bank) => op =>
    {
      switch (op)
      {
        ...
        case 4:
          ...
          return Some<Result<Bank, string>>(bank);
        case 5:
          return None;
        default:
          return Some<Result<Bank, string>>($"unknown operation: {op}");
      }
    };
    ...
    private static Result<Bank, string> CreateAccount(Bank bank)
    {
      ...
      return Console.ReadLine()
                    ...
                    .DoIfSuccess(b => Console.WriteLine("Created account!"));
    }
    ...
    private static Result<Bank, string> Deposit(Bank bank)
    {
      ...
      return TryParseAccountIdAndAmount(accountIdInput, amountInput)
        ...
        .DoIfSuccess(b => Console.WriteLine("Deposited amount!"));
    }
    ...
    private static Result<Bank, string> Withdraw(Bank bank)
    {
      ...
      return TryParseAccountIdAndAmount(accountIdInput, amountInput)
        ...
        .DoIfSuccess(b => Console.WriteLine("Withdrew amount!"));
    }
